  ...
  return (
    ...
    >
      ...
      <div className="mt-auto">
        ...
        <a
          href="/Teja_Resume.pdf"
          download
          className="group flex items-center justify-center gap-2 bg-[#111111] text-[#E8E6E1] py-3 px-6 rounded-full text-xs font-bold uppercase tracking-wider hover:bg-[#333] transition-colors mb-8 w-full"
        >
